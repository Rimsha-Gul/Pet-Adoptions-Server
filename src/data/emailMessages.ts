export const getVerificationCodeEmail = (verificationCode: string) => {
  ...
  const message = `
    <p>Your email verification code is: <strong>${verificationCode}</strong>.</p><p>Do not share this code with anyone else.</p>
    <p>Best,</p>
...
export const getResetPasswordEmail = (resetToken: string) => {
  ...
  const message = `
    ...
    <p><a href="${process.env.WEB_APP_URL}/resetPassword/${resetToken}/">Reset</a></p>
...
export const getApplicantHomeVisitScheduledEmail = (
  ...
  const message = `
    ...
    <p>The visit is set for: <strong>${formattedDate} UTC</strong></p>
...
export const getShelterInvitationEmail = (invitationLink: string) => {
  ...
  const message = `
    ...
    <p>To accept this invitation and begin the registration process, please click <a href="${process.env.WEB_APP_URL}/shelter/invitation/${invitationLink}/">here</a></p>
